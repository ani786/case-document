...
import com.mydocumentsref.api.portal.internal.casedocumentservice.repository.DeleteInternalDocumentJDBCRepository;
...
public class DeleteInternalDocumentDelegate {
    ...
    public DeleteInternalDocumentResponse deleteInternalDocument(final DeleteInternalDocumentRequest request) {
        ...
        DeleteInternalDocumentResponse deleteInternalDocumentResponse =
                    DeleteInternalDocumentResponse.builder().userCode(request.getUserCode()).responseMessage(com.mydocumentsref.api.common.commonservice.util.Constants.SUCCESS)
