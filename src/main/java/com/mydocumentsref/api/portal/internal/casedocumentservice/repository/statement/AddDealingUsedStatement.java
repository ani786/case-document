...
/**
 * The enum Add dealing used statement.
 */
public enum AddDealingUsedStatement {
    ;
    /**
    ...
    public static final String INSERT_INTO_PACKET_IMAGE = """
                ...
                VALUES (PACKET_IMAGE_ID_SEQ.NEXTVAL, :packetId, 'DLG', 'DL', :subType, null, :pathValue, null, SYSTIMESTAMP, :userCode, 'P', SYSTIMESTAMP, :fmtDlgNum)
                 """;
